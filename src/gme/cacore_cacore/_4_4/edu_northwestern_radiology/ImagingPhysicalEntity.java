...
import uri.iso_org._21090.REAL;
...
@XmlType(name = "ImagingPhysicalEntity", propOrder = {
    "typeCode",
    "questionTypeCode",
    "isPresent",
    "annotatorConfidence",
    ...
    extends Entity
{
    ...
    public static class ImagingObservationCharacteristicCollection {
        ...
        @XmlElement(name = "ImagingObservationCharacteristic", required = true)
    ...
    public static class ImagingPhysicalEntityCharacteristicCollection {
        ...
        @XmlElement(name = "ImagingPhysicalEntityCharacteristic", required = true)
